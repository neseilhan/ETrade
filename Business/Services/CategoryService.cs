        ...
        public Result Delete(int id)
        {
            try
            {
                ...
                if (category.Products != null && category.Products.Count > 0)
                {
                    ...
                    //}
                    ////_productRepository.Save(); // product repository'de Save() methodunu çağırmaya gerek yok çünkü aşağıdaki category
                    // repository'nin Delete() methodu save parametresini true gönderdiğimizden category repository'de
                    // Save() methodunu çağırıyor ve ürünleri silme işlemini de veritabanına iletiyor.
