...
namespace Business.Models
{
    public class ProductModel : RecordBase
    {
        ...
        //[DisplayName("Unit Price")]
        //public string UnitPriceText => UnitPrice.ToString(new CultureInfo("en-US"));
        ...
        //[DisplayName("Expiration Date")]
        //public string ExpirationDateText => ExpirationDate.HasValue ? ExpirationDate.Value.ToString("MM/dd/yyyy", new CultureInfo("en-US")) : "";
