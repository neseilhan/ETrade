    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ETradeOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ETradeOrders_ETradeUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "ETradeUsers",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "ETradeProductOrders",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ETradeProductOrders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ETradeProductOrders_ETradeOrders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "ETradeOrders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ETradeProductOrders_ETradeProducts_ProductId",
                        column: x => x.ProductId,
                        principalTable: "ETradeProducts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ETradeOrders_UserId",
                table: "ETradeOrders",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ETradeProductOrders_OrderId",
                table: "ETradeProductOrders",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ETradeProductOrders_ProductId",
                table: "ETradeProductOrders",
                column: "ProductId");
